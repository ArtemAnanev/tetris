...
import { isValidPos, moveOnClickLeft, moveOnClickRight, rapidFallOnDawn, rotateOnClickUp, showGameMessage, showNextTetromino, shuffle, tetrisResize } from "./utils.js"


const app = (difficulty) => {
    const gameContent = document.querySelector('.game-menu')
    ...
    document.addEventListener('keydown',
        (e) => {
            ...
            if (e.which === 40) {
                rapidFallOnDawn(tetromino, playArea, placeTetromino)
            }
            if (e.which === 38) {
    ...
    bottomArrow.addEventListener('click', () => rapidFallOnDawn(tetromino, playArea, placeTetromino))
